...
{
    public class GarotaImagemViewModel
    {
        [Key]
       ...
       // [StringLength(8, ErrorMessage = "O campo {0} precisa ter entre {2} e {1} caracteres", MinimumLength = 8)]
        ...
        [DisplayName("Imagem Doc Frente")]
        public IFormFile imagem_doc_frente_upload { get; set; }

        [DisplayName("Imagem Doc Ctras")]
        public IFormFile imagem_doc_tras_upload { get; set; }
