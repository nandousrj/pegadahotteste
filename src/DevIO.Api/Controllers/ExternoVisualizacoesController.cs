...
{
      [Route("api/ExternoVisualizacoes")]
    //  [Authorize]
  //  [ApiVersion("1.0")]
   // [Route("api/v{version:apiVersion}/ExternoVisualizacoes")]
    public class ExternoVisualizacoesController : MainController
    {
        ...
        public ExternoVisualizacoesController(IVisualizacaoRepository visualizacaoRepository,
      ...
      //  [AllowAnonymous]
        ...
        public async Task<ActionResult<int>> RetornarTotalVisualizacaoGarotasPOC()
        {
         ...
         //Ranking
        [AllowAnonymous]
        [HttpGet("RetornarTotalVisualizacaoGarotasTotal")]
        public async Task<ActionResult<int>> RetornarTotalVisualizacaoGarotasTotalPOC()
        {
            int dados = _mapper.Map<int>(await _visualizacaoRepository.RetornarTotalVisualizacaoGarotasPOC());
        ...
        //GrupoPegadora -- ok
        //[AllowAnonymous]
        //[HttpPost("AlterarSiteVisualizacaoGrupo")]
        //public async Task<int> AlterarSiteVisualizacaoGrupo(int id_grupo)
        //{
        //    int quantidade = await _visualizacaoRepository.AlterarSiteVisualizacaoGrupoPOC(id_grupo);
        //    return quantidade;
        //}


        //index -- ainda não testado
        //[AllowAnonymous]
        //[HttpPost("AlterarSiteVisualizacao")]
        //public async Task<int> AlterarSiteVisualizacao()
        //{
        //    int quantidade = await _visualizacaoRepository.AlterarSiteVisualizacaoPOC();
        //    return quantidade;
        //}
