...
namespace DevIO.Api.Controllers
{
  ...
  //  [Authorize]
    [ApiVersion("1.0")]
    [Route("api/v{version:apiVersion}/ExtGarotaCategorias")]
    public class ExtGarotaCategoriaCategoriasController : MainController
    {
        ...
        public ExtGarotaCategoriaCategoriasController(IGarotaCategoriaRepository garotacategoriaRepository,
        ...
        //index
        [AllowAnonymous]
        [HttpGet]//("RetornarDadosPrincipal/{id_categoria:int}/{desc_zona}/{ind_destaque:int}/{apelido}/{id_estilo:int}")]
